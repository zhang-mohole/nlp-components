# this file copy from https://github.com/budzianowski/PyTorch-Beam-Search-Decoding
# and the original code is based on https://github.com/shawnwun/NNDIAL. 

# now this code has not been tested!!!
